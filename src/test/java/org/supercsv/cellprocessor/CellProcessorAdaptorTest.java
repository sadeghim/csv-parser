...
public class CellProcessorAdaptorTest {
	...
	public void testToString() {
		assertEquals("org.org.supercsv.mock.IdentityTransform", new IdentityTransform().toString());
	}
	...
	public void testValidUnchained() {
		...
		assertEquals("org.org.supercsv.cellprocessor.CellProcessorAdaptor$NullObjectPattern", processor.next.getClass()
			.getName());
