...
public class Reading {
	...
	private static final String CSV_FILENAME = "src/test/resources/customers_with_different_escape_char.csv";
	...
	private static void readWithCsvListReader() throws Exception {
		...
		try {
			listReader = new CsvListReader(new FileReader(CSV_FILENAME),csvPreference);
	...
	private static void readVariableColumnsWithCsvListReader() throws Exception {
		...
		ICsvListReader listReader = null;
		try {
			listReader = new CsvListReader(new FileReader(VARIABLE_CSV_FILENAME),csvPreference);
