...
/**
 * Converts a double into a formatted string using the {@link java.text.DecimalFormat} class and the default locale. This is
 ...
 *
 * <br>
 * If you want to convert from a String to a decimal, use the {@link org.supercsv.cellprocessor.ParseDouble} or {@link org.supercsv.cellprocessor.ParseBigDecimal} processor.
 *
 * @since 1.50
...
public class FmtNumber extends CellProcessorAdaptor implements DoubleCellProcessor, LongCellProcessor {
	 ...
	 *
	 * @param decimalFormat
	 *            the decimal format String (see {@link java.text.DecimalFormat})
	 ...
	 * {@inheritDoc}
	 *
	 * @throws org.supercsv.exception.SuperCsvCellProcessorException
