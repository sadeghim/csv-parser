...
/**
 * Converts a date into a formatted string using the {@link java.text.SimpleDateFormat} class. If you want to convert from a
 * String to a Date, use the {@link org.supercsv.cellprocessor.ParseDate} processor.
 * <p>
...
public class FmtDate extends CellProcessorAdaptor implements DateCellProcessor {
	 ...
	 *
	 * @param dateFormat
	 *            the date format String (see {@link java.text.SimpleDateFormat})
