...
/**
 * Converts a String to a Date using the {@link java.text.SimpleDateFormat} class. If you want to convert from a Date to a String,
 * use the {@link org.supercsv.cellprocessor.FmtDate} processor.
 * <p>
 ...
 * a 'lenient' parameter). See {@link java.text.SimpleDateFormat#setLenient(boolean)} for more information.
 * <p>
